function das3implicit_sim(block)
...
block.InputPort(1).Dimensions        = 138;
...
block.OutputPort(2).Dimensions       = 138;
block.OutputPort(2).DatatypeID  = 0; % double
block.OutputPort(2).Complexity  = 'Real';
block.OutputPort(2).SamplingMode = 'Sample';
block.OutputPort(2).SampleTime = [0.01 0];
...
function InputSamplingTime(s, port, time) 
%endfunction Input Sampling Time 

function OutputSamplingTime(s, port, time) 
%endfunction Output Sampling Time 
...
block.OutputPort(1).Data = block.Dwork(1).Data(1:11);
block.OutputPort(2).Data = das3mex('Muscleforces',block.Dwork(1).Data);
...
block.Dwork(1).Data = das3step(block.Dwork(1).Data, block.InputPort(1).Data, 0.001);
